...
class NERModel(BaseModel):
    ...
    def get_feed_dict(self, words, labels=None, lr=None, dropout=None):
        ...
        if self.config.use_large_embeddings:
            ...
            feed[self.backoff_embeddings_change_values] = self.config.oov_embeddings if hasattr(self.config, "oov_embeddings") else 0
        if self.config.use_chars:
    ...
    def add_word_embeddings_op(self):
        ...
        with tf.variable_scope("words"):
            backoff_embeddings_change = None
    ...
    def run_epoch(self, train, dev, epoch):
        """Performs one complete pass over the train set and evaluate on 00_dev
